...
#define MAP_PAGE_JUST_DIRTIED UINT64CONST(0x0000020000000000)
#define MAP_PAGE_CHECKPOINT_NEEDED UINT64CONST(0x0000040000000000)
...
{
	MapPageDesc *desc;
	/* A critical-section caller owns this pin explicitly. */
	bool		raw_pin;
} MapPageBuffer;
...
extern void MapPageCheckpoint(void);
