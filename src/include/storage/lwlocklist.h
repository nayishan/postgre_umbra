...
PG_LWLOCKTRANCHE(MAP_PAGE_MAPPING, MapPageMapping)
PG_LWLOCKTRANCHE(MAP_PAGE_CONTENT, MapPageContent)
PG_LWLOCKTRANCHE(MAP_PAGE_EXTENSION, MapPageExtension)
PG_LWLOCKTRANCHE(MAP_SUPER_MAPPING, MapSuperMapping)
PG_LWLOCKTRANCHE(MAP_SUPER_CONTENT, MapSuperContent)
PG_LWLOCKTRANCHE(MAP_RECLAIM_MAPPING, MapReclaimMapping)
