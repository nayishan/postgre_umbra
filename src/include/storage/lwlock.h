...
#define NUM_SHD_REL_LOCKS   (MAX_SHD_REL) //1 rel 3 type files
...
#define	SHDBLK_MAPPING_LWLOCK_OFFSET \
	(PREDICATELOCK_MANAGER_LWLOCK_OFFSET + NUM_PREDICATELOCK_PARTITIONS)
#define	SHD_RELID_MAPPING_LWLOCK_OFFSET \
	(SHDBLK_MAPPING_LWLOCK_OFFSET + NUM_SHD_REL_LOCKS)
#define NUM_FIXED_LWLOCKS \
	(SHD_RELID_MAPPING_LWLOCK_OFFSET + MAX_SHD_DBS)
...
typedef enum BuiltinTrancheIds
{
	...
	LWTRANCHE_SHDBLK_MAPPING,
	LWTRANCHE_SHD_RELID_MAPPING,
