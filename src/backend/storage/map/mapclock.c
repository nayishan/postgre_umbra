 ...
 *
 * This pool is independent of the resident superblock table.  It follows the
 * shared-buffer shape: a partitioned tag hash protects identity lookup, while
 * a freelist and clock sweep choose unpinned victims.
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
