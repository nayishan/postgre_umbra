...
use constant ROOT_FLAG_FSM_SLOT0 => 0x00000002;
use constant ROOT_FLAG_VM_SLOT0 => 0x00000004;
...
# Persist a valid root without auxiliary activation, then leave birth in WAL.
$node->safe_psql(
	'postgres', q{
...
is(root_u32($root_without_aux, ROOT_FLAGS_OFFSET), 1,
